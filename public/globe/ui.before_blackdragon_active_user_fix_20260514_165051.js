...
(function () {
  ...
  function ensureFounderAccount(store) {
    ...
    if (!store.users["founder_001"]) {
      store.users["founder_001"] = createDefaultUser("founder_001", ROLES.FOUNDER);
    }
    ...
    const founder = createDefaultUser("founder_001", ROLES.FOUNDER);

    store = {
      active_user: "founder_001",
      users: {
        founder_001: founder
      }
    };
