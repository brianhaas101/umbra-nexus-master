// scripts/clients/black_dragon/build_target_output_layer.js

const fs = require("fs");
const path = require("path");

const INPUT_PATH = path.join(__dirname, "../../data/clients/black_dragon/scored_targets.json");
const READY_PATH = path.join(__dirname, "../../data/clients/black_dragon/ready_targets.json");
const ENRICH_PATH = path.join(__dirname, "../../data/clients/black_dragon/enrichment_queue.json");
