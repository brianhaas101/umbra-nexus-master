...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "asset_infrastructure_source_entity",
    layer_id: "L06",
...
writeJson("public/data/intelligence/outputs/L06_ASSET_INFRASTRUCTURE_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L06_OPERATIONAL_OUTPUT_BUILT",
