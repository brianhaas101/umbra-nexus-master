...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "behavioral_demand_source_entity",
    layer_id: "L05",
...
writeJson("public/data/intelligence/outputs/L05_BEHAVIORAL_DEMAND_SIGNAL_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L05_OPERATIONAL_OUTPUT_BUILT",
