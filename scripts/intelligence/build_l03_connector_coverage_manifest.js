...
const connectors = registry.sources.map((source, index) => ({
  connector_id: `L03_CONNECTOR_${String(index + 1).padStart(3, "0")}_${source.source_id}`,
  layer_id: "L03",
...
writeJson("public/data/intelligence/runtime/L03_local_connector_coverage_manifest.json", {
  version: "nexus_L03_local_connector_coverage_manifest_v1",
  generated_at: now,
  layer_id: "L03",
...
console.log(JSON.stringify({
  status: "L03_CONNECTOR_COVERAGE_MANIFEST_BUILT",
  connectors: connectors.length,
  file: "public/data/intelligence/runtime/L03_local_connector_coverage_manifest.json"
}, null, 2));
