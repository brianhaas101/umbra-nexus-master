...
const registry = readJson(
  "public/data/intelligence/sources/L08_FINANCIAL_BUDGET_FUNDING_INTELLIGENCE.sources.json"
);
...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "financial_budget_entity",
    layer_id: "L08",
  ...
  signals.push({
    ...
    strength: source.authority_score,
    confidence: source.authority_score
  });
...
writeJson(
  "public/data/intelligence/outputs/L08_COMMAND_STRUCTURE.normalized.json",
  {
...
console.log(JSON.stringify({
  status: "L08_OPERATIONAL_OUTPUT_REBUILT",
