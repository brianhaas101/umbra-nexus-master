...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "contact_decision_maker_source_entity",
    layer_id: "L09",
...
writeJson("public/data/intelligence/outputs/L09_CONTACT_DECISION_MAKER_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L09_OPERATIONAL_OUTPUT_BUILT",
