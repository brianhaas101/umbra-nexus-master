...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "commercial_intelligence_source_entity",
    layer_id: "L04",
...
writeJson("public/data/intelligence/outputs/L04_PRIVATE_SECTOR_COMMERCIAL_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L04_OPERATIONAL_OUTPUT_BUILT",
