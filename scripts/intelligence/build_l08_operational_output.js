...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "financial_budget_source_entity",
    layer_id: "L08",
...
writeJson("public/data/intelligence/outputs/L08_FINANCIAL_BUDGET_FUNDING_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L08_OPERATIONAL_OUTPUT_BUILT",
