...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "state_public_safety_source_entity",
    layer_id: "L02",
...
writeJson("public/data/intelligence/outputs/L02_STATE_PUBLIC_SAFETY_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L02_OPERATIONAL_OUTPUT_BUILT",
