...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "risk_compliance_legal_source_entity",
    layer_id: "L11",
...
writeJson("public/data/intelligence/outputs/L11_RISK_COMPLIANCE_LEGAL_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L11_OPERATIONAL_OUTPUT_BUILT",
