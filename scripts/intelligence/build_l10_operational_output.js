...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "communication_outreach_source_entity",
    layer_id: "L10",
...
writeJson("public/data/intelligence/outputs/L10_COMMUNICATION_OUTREACH_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L10_OPERATIONAL_OUTPUT_BUILT",
