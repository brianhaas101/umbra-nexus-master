...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "engagement_response_source_entity",
    layer_id: "L12",
...
writeJson("public/data/intelligence/outputs/L12_ENGAGEMENT_RESPONSE_CONVERSION_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L12_OPERATIONAL_OUTPUT_BUILT",
