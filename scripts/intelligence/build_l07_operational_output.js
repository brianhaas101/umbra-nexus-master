...
for (const source of registry.sources) {
  ...
  entities.push({
    entity_id,
    entity_type: "operational_activity_source_entity",
    layer_id: "L07",
...
writeJson("public/data/intelligence/outputs/L07_OPERATIONAL_ACTIVITY_INTELLIGENCE.normalized.json", {
...
console.log(JSON.stringify({
  status: "L07_OPERATIONAL_OUTPUT_BUILT",
