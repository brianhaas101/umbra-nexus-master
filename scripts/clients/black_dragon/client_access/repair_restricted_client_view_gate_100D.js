...
function readJson(file) {
  ...
  if (!fs.existsSync(abs)) {
    throw new Error("Missing required input: " + abs);
  }
...
const clientView = {
  version: "black_dragon_restricted_client_view_gate_v1_batch_100D",
...
ensureDir("public/data/clients/black_dragon/client_access/view_gate");
...
console.log(JSON.stringify({
  status: "RESTRICTED_CLIENT_VIEW_GATE_FILE_WRITE_COMPLETE",
  output_exists: fs.existsSync(path.resolve("public/data/clients/black_dragon/client_access/view_gate/restricted_client_view_gate.v1.json")),
