...
const log = {
  ...
  runner_id: "DAILY_FRESHNESS_RUNNER",
...
const out = path.join(
  ROOT,
  "public/data/clients/black_dragon/automation/execution_logs/daily_freshness_runner_execution_log.json"
);
...
console.log(JSON.stringify({
  status: "DAILY_FRESHNESS_RUNNER_READY",
  output: out
}, null, 2));
