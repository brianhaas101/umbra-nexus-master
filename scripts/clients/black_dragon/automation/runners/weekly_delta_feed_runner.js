...
const log = {
  ...
  runner_id: "WEEKLY_DELTA_FEED_RUNNER",
...
const out = path.join(
  ROOT,
  "public/data/clients/black_dragon/automation/execution_logs/weekly_delta_feed_runner_execution_log.json"
);
...
console.log(JSON.stringify({
  status: "WEEKLY_DELTA_FEED_RUNNER_READY",
  output: out
}, null, 2));
