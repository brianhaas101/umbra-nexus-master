...
const imports = {
  version: "black_dragon_mesa_discovery_import_v1",
  generated_at: new Date().toISOString(),
  city: "Mesa",
  state: "AZ",
  imported_candidates: [
    {
      candidate_id: "BD_MSA_IMPORT_001",
      organization_name: "Harley-Davidson of Mesa",
      ...
      public_route_url: "https://www.hdofmesa.com/",
      source_lineage: ["ARIZONA_DEALERSHIP_DISCOVERY", "MESA_LUXURY_MOTO_OVERLAP"]
    },
    {
      candidate_id: "BD_MSA_IMPORT_002",
      ...
      source_lineage: ["ARIZONA_EVENT_DISCOVERY", "MESA_REGIONAL_RALLY_NETWORK"]
    },
    {
      candidate_id: "BD_MSA_IMPORT_003",
      organization_name: "Mesa Bike Week Vendor Network",
    ...
    {
      candidate_id: "BD_MSA_IMPORT_004",
      ...
      source_lineage: ["POWERSPORTS_DEALER_DISCOVERY", "MESA_RETAIL_NETWORK"]
    },
    {
      candidate_id: "BD_MSA_IMPORT_005",
      organization_name: "Mesa Motorcycle Riders Network",
      ...
      source_lineage: ["COMMUNITY_GROUP_SCAN", "MESA_RIDER_NETWORK"]
    },
    {
      candidate_id: "BD_MSA_IMPORT_006",
      organization_name: "WestWorld of Mesa Event Network",
      ...
      source_lineage: ["EVENT_VENUE_DISCOVERY", "MESA_EVENT_INFRASTRUCTURE"]
    },
    {
      candidate_id: "BD_MSA_IMPORT_007",
    ...
    {
      candidate_id: "BD_MSA_IMPORT_008",
    ...
    {
      candidate_id: "BD_MSA_IMPORT_009",
      organization_name: "Mesa Charity Ride Network",
      ...
      source_lineage: ["CHARITY_RIDE_DISCOVERY", "MESA_COMMUNITY_EVENTS"]
    },
    {
      candidate_id: "BD_MSA_IMPORT_010",
      organization_name: "Mesa Custom Motorcycle Culture",
      organization_type: "CUSTOM_MOTORCYCLE_COMMUNITY",
      source_category: "MEDIA_AND_COMMUNITY",
      estimated_influence_score: 8.5,
      estimated_conversion_score: 8.2,
      public_route_url: "https://www.facebook.com/search/top?q=mesa%20motorcycle",
      source_lineage: ["CUSTOM_CULTURE_DISCOVERY", "MESA_MOTORCYCLE_COMMUNITY"]
    }
  ],
  discovery_laws: {
...
fs.writeFileSync(
  path.join(ROOT, "public/data/clients/black_dragon/candidate_queue/mesa/imports/mesa_discovery_import.json"),
...
fs.writeFileSync(
  path.join(ROOT, "public/data/clients/black_dragon/candidate_queue/mesa/validated/mesa_validated_candidates.json"),
  JSON.stringify({ version: "black_dragon_mesa_validated_candidates_v1", generated_at: new Date().toISOString(), city: "Mesa", state: "AZ", validated_candidate_count: validated.length, validated_candidates: validated }, null, 2),
  "utf8"
);
...
const deduped = validated.map(candidate => {
  ...
  return {
    ...
    duplicate_resolution: duplicate ? "ARIZONA_OR_INTERSTATE_REGIONAL_REVIEW_REQUIRED" : "UNIQUE_MESA_ENTITY",
    founder_review_required: duplicate
  };
});

const dedupePayload = {
  version: "black_dragon_mesa_regional_dedupe_v1",
  generated_at: new Date().toISOString(),
  city: "Mesa",
  state: "AZ",
...
fs.writeFileSync(
  path.join(ROOT, "public/data/clients/black_dragon/candidate_queue/mesa/dedupe/mesa_regional_dedupe.json"),
  JSON.stringify(dedupePayload, null, 2),
  "utf8"
);

const audit = {
  version: "black_dragon_batch_164_mesa_discovery_import_audit_v1",
  generated_at: new Date().toISOString(),
  batch: "164_MESA_ENTITY_DISCOVERY_IMPORT",
  counts: {
  ...
  next_phase: "BATCH_165_MESA_RUNTIME_MERGE_AND_GRAPH",
  status: "PASS"
};

const out = path.join(ROOT, "public/data/clients/black_dragon/candidate_queue/mesa/audit/batch_164_mesa_discovery_import_audit.json");
fs.writeFileSync(out, JSON.stringify(audit, null, 2), "utf8");

console.log(JSON.stringify({
  status: "BATCH_164_MESA_DISCOVERY_IMPORT_AUDIT_COMPLETE",
