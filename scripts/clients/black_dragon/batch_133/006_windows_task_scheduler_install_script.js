...
# Registers Windows Scheduled Tasks for Long Beach production runners
# Safe install script only — does not run tasks immediately
# =========================================================
...
Write-Host ""
Write-Host "Black Dragon Long Beach scheduled task installation complete."
`;
...
console.log(JSON.stringify({
  status: "WINDOWS_TASK_SCHEDULER_INSTALL_SCRIPT_COMPLETE",
  output: out
}, null, 2));
