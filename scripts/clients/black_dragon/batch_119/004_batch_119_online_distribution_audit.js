...
const audit = {
  version: "black_dragon_batch_119_online_distribution_audit_v1",
  generated_at: new Date().toISOString(),
  batch: "119_LONG_BEACH_ONLINE_SOCIAL_CONTENT_DISTRIBUTION",
...
const out = path.join(
  ROOT,
  "public/data/clients/black_dragon/online_distribution_layer/audit/batch_119_online_distribution_audit.json"
);

fs.writeFileSync(out, JSON.stringify(audit, null, 2));

console.log(JSON.stringify({
  status: "BATCH_119_ONLINE_DISTRIBUTION_AUDIT_COMPLETE",
