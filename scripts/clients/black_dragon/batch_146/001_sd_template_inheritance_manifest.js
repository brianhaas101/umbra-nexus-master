...
const manifest = {
  version: "black_dragon_san_diego_template_inheritance_manifest_v1",
  generated_at: new Date().toISOString(),

  source_template_city: "Long Beach",
  target_city: "San Diego",
  target_state: "CA",

  inheritance_status: "STRUCTURE_ALIGNED_ENTITY_IMPORT_PENDING",

  inherited_components: longBeachTemplate.export_components,
  inherited_hardlocks: longBeachTemplate.inherited_hardlocks,
  ...
  corridor_context: {
    corridor: "SOUTHERN_CALIFORNIA",
    existing_operational_cities: [
      "Long Beach",
      "Los Angeles"
    ],
    expected_cross_city_overlap: true
  },
...
console.log(JSON.stringify({
  status: "SAN_DIEGO_TEMPLATE_INHERITANCE_MANIFEST_COMPLETE",
