...
const imported = JSON.parse(fs.readFileSync(
  path.join(ROOT, "public/data/clients/black_dragon/bulk_order_layer/imports/long_beach_bulk_order_import.json"),
  "utf8"
));
...
fs.writeFileSync(out, JSON.stringify({
  version: "black_dragon_long_beach_bulk_order_validated_v1",
...
console.log(JSON.stringify({
  status: "LONG_BEACH_BULK_ORDER_VALIDATION_COMPLETE",
  validated_count: validated.length,
  output: out
}, null, 2));
